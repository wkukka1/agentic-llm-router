...
from decompose.classifiers.prompt_decomposition.signals import SURFACE_FEATURES, extract, extract_many
from decompose.classifiers.prompt_decomposition.signals.surface import SurfaceSignals
