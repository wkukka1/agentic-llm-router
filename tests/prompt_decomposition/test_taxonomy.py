...
from decompose.classifiers.prompt_decomposition.heads.domain_taxonomy import (
    DOMAIN_DESCRIPTIONS,
    DOMAIN_LABELS,
    Domain,
...
class TestTaskTypes:
    ...
    def test_dolly_question_variants_collapse_to_one_task(self):
        ...
        from decompose.classifiers.prompt_decomposition.heads.task_taxonomy import TaskType, task_from_dolly

        for c in ("open_qa", "general_qa", "closed_qa"):
            assert task_from_dolly(c) is TaskType.ANSWER

    def test_every_dolly_category_maps(self):
        from decompose.classifiers.prompt_decomposition.heads.task_taxonomy import DOLLY_MAP, task_from_dolly
    ...
    def test_task_axis_is_independent_of_domain(self):
        ...
        from decompose.classifiers.prompt_decomposition.heads.domain_taxonomy import DOMAIN_LABELS
        from decompose.classifiers.prompt_decomposition.heads.task_taxonomy import TASK_LABELS
