...
from decompose.classifiers.prompt_decomposition.heads.length import BUCKETS, LengthHead
from decompose.classifiers.prompt_decomposition.heads.length_model import (
    LengthModel,
    bootstrap_ci,
    evaluate,
    interval_coverage,
)
from evaluation.prompt_decomposition.length_audit import audit
from training.prompt_decomposition.data.arena_corpus import _first_user_text, _split_of
...
class TestCorpusGuard:
    ...
    def test_the_threshold_sits_between_the_two_cases(self):
        from training.prompt_decomposition.data.arena_corpus import SERIALISED_PROMPT_LIMIT
...
class TestCeiling:
    ...
    def test_the_averaged_target_is_more_reproducible_than_one_model(self):
        ...
        from evaluation.prompt_decomposition.length_audit import target_ceiling
...
class TestRoutingValue:
    ...
    def test_a_signal_unrelated_to_the_decision_scores_at_chance(self, monkeypatch):
        ...
        from evaluation.prompt_decomposition import routing_value as rv
...
class TestArtifactNaming:
    ...
    def test_each_encoder_gets_its_own_run_directory(self, tmp_path, learnable):
        ...
        from training.prompt_decomposition.heads.length import _save
