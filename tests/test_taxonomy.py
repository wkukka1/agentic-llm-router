...
from router.prompt_decomposition.heads.domain_taxonomy import (
    DOMAIN_DESCRIPTIONS,
    DOMAIN_LABELS,
    Domain,
...
def test_software_tech_owns_questions_about_ai():
    ...
    from router.prompt_decomposition.heads.domain_taxonomy import DOMAIN_DESCRIPTIONS
...
class TestTaskTypes:
    ...
    def test_six_distinct_tasks(self):
        from router.prompt_decomposition.heads.task_taxonomy import TASK_DESCRIPTIONS, TASK_LABELS
    ...
    def test_media_is_its_own_task_not_a_kind_of_create(self):
        ...
        from router.prompt_decomposition.heads.task_taxonomy import TASK_LABELS, TaskType
    ...
    def test_dolly_question_variants_collapse_to_one_task(self):
        ...
        from router.prompt_decomposition.heads.task_taxonomy import TaskType, task_from_dolly

        for c in ("open_qa", "general_qa", "closed_qa"):
            assert task_from_dolly(c) is TaskType.ANSWER

    def test_every_dolly_category_maps(self):
        from router.prompt_decomposition.heads.task_taxonomy import DOLLY_MAP, task_from_dolly
    ...
    def test_task_axis_is_independent_of_domain(self):
        ...
        from router.prompt_decomposition.heads.domain_taxonomy import DOMAIN_LABELS
        from router.prompt_decomposition.heads.task_taxonomy import TASK_LABELS
    ...
    def test_ideate_is_merged_into_answer(self):
        ...
        from router.prompt_decomposition.heads.task_taxonomy import TASK_LABELS, TaskType, task_from_dolly
