...
from decompose.classifiers.prompt_decomposition.features import FEATURE_SETS
...
def cmd_length(args: argparse.Namespace) -> int:
    ...
    print()
    for result in audit_feature_sets(encoder_model=args.encoder, feature_sets=feature_sets,
