...
from decompose.classifiers.prompt_decomposition.calibration import apply_temperature


class DomainClassifier(ABC):
    """Predicts a distribution over :data:`~decompose.classifiers.prompt_decomposition.heads.domain_taxonomy.DOMAIN_LABELS`.
