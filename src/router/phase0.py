...
Phase 1 consumes everything through `router.data.phase1.load_phase1`.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.embeddings:
        ...
        from .embeddings import available_pathways, build_store, default_store_dir, load_encoder
