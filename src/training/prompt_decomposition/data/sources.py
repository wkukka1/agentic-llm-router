...
def load_real_tasks(path: str = REAL_TASKS_PATH) -> list[Example]:
    ...
    `answer`. See :mod:`decompose.classifiers.prompt_decomposition.heads.task_taxonomy` for the full comparison.
    """
...
def load_dolly_tasks() -> list[Example]:
    ...
    fifteen to one; the measurements are in :mod:`decompose.classifiers.prompt_decomposition.heads.task_taxonomy`.
    """
    from decompose.classifiers.prompt_decomposition.heads.task_taxonomy import task_from_dolly
