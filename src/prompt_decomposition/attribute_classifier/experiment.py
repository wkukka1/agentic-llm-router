...
from prompt_decomposition.attribute_classifier.taxonomy import ATTRIBUTE_NAMES, describe
from prompt_decomposition.core.arena_corpus import load_arena_splits
from prompt_decomposition.core.arena_labels import label_for, load_arena_labels
from prompt_decomposition.core.features import build_features
from prompt_decomposition.core.metrics import expected_calibration_error
...
def run_attribute_sweep(*, encoder_model: str = DEFAULT_ENCODER,
    ...
    if "embedding" in feature_set:
        from prompt_decomposition.length_estimator.experiment import encode_splits
