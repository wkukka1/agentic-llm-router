...
Loaders live in :mod:`prompt_decomposition.core.sources`. This module owns the row type every
...
def build_task_dataset(
    *,
    ...
    mixing it in costs accuracy at every ratio tried. See :mod:`prompt_decomposition.task_classifier.taxonomy`.
    ...
    """
    from prompt_decomposition.core import sources
